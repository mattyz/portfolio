...
#
 5.times do |blog|
  b = Blog.new( title: "Blog Post #{blog}",  body:' Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eu facilisis lorem. In bibendum eu nisl egestas hendrerit. Praesent volutpat odio at nulla semper, in rhoncus velit pellentesque. Sed maximus nibh vel jus' )
  b.save!
 end

 puts "created 5 blogs!!"
